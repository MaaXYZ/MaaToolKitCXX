...
{
public:
    static constexpr std::string_view kLogFilename = "maa_toolkit.log";
    static constexpr std::string_view kLogbakFilename = "maa_toolkit.bak.log";
...
#define MAA_FILE MAA_TOOLKIT_NS::pertty_file(__FILE__)
...
#define LogDebug MAA_TOOLKIT_NS::Logger::get_instance().debug(LOG_ARGS)
#define LogTrace MAA_TOOLKIT_NS::Logger::get_instance().trace(LOG_ARGS)
#define LogInfo MAA_TOOLKIT_NS::Logger::get_instance().info(LOG_ARGS)
#define LogWarn MAA_TOOLKIT_NS::Logger::get_instance().warn(LOG_ARGS)
#define LogError MAA_TOOLKIT_NS::Logger::get_instance().error(LOG_ARGS)
...
#define LogFunc                                                              \
    MAA_TOOLKIT_NS::LogUtils::ScopeLeaveHelper LogScopeHeplerName(LOG_ARGS); \
    MAA_TOOLKIT_NS::LogUtils::ScopeEnterHelper(LOG_ARGS)()

#define VAR_RAW(x) "[" << #x << "=" << (x) << "] "
#define VAR(x) MAA_TOOLKIT_NS::Logger::separator::none << VAR_RAW(x) << MAA_TOOLKIT_NS::Logger::separator::space
#define VAR_VOIDP_RAW(x) "[" << #x << "=" << ((void*)x) << "] "
#define VAR_VOIDP(x) \
    MAA_TOOLKIT_NS::Logger::separator::none << VAR_VOIDP_RAW(x) << MAA_TOOLKIT_NS::Logger::separator::space
